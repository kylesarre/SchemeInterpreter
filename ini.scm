...
(define (and . args)
  (cond
    ((null? args) #t)
    ((null? (cdr args)) (if (car args) (car args) #f))
    (else (if (car args) (apply and (cdr args)) #f))
  )
)
(define (or . args)
  (cond
    ((null? args) #t)
    ((null? (cdr args)) (car args))
    (else (if (car args) (car args) (apply or (cdr args))))
  )
)
(define (list . args)
  (cond
...
(define (append . args)
  (cond
    ...
    (else (cons (caar args) (apply append (cdar args) (cdr args))))
  )
)
(define (reverse l)
  (cond
...
(define (memq obj list)
  (cond
    ((null? list) #f)
    (else (if (eq? obj (car list)) list (memq obj (cdr list))))
  )
)
(define (memv obj list)
  (cond
    ((null? list) #f)
    (else (if (eqv? obj (car list)) list (memq obj (cdr list))))
  )
)
(define (member obj list)
  (cond
    ((null? list) #f)
    (else (if (equal? obj (car list)) list (memq obj (cdr list))))
  )
)
(define (assq obj alist)
  (cond
    ((null? alist) #f)
    (else (if (eq? obj (caar alist)) (cadar alist) (assq obj (cdr alist))))
  )
)
(define (assv obj alist)
  (cond
    ((null? alist) #f)
    (else (if (eqv? obj (caar alist)) (cadar alist) (assv obj (cdr alist))))
  )
)
(define (assoc obj alist)
  (cond
    ((null? alist) #f)
    (else (if (equal? obj (caar alist)) (cadar alist) (assoc obj (cdr alist))))
  )
)
(define (singlemap . args)
  (cond
    ((null? (cdr args)) '())
    ((null? (cadr args)) '())
    (else (cons
      ((car args) (cadr args))
      (apply singlemap (car args) (cddr args))
      )
    )
  )
)
(define (map . args)
  (cond
    ((null? (cadr args)) '())
    (else (cons
      (apply (car args) (apply singlemap car (cdr args)))
      (apply map (car args) (apply singlemap cdr (cdr args))))
    )
  )
)
